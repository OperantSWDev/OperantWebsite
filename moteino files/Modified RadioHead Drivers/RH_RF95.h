...
// This .h file has small additions to support two new commands: setModeCAD() and sendWithDelay
...
public:
    ...
    RH_RF95(uint8_t slaveSelectPin = 4, uint8_t interruptPin = 2, RHGenericSPI& spi = hardware_spi);
#else
    ...
    // RK changes
    /// If current mode is Rx or Tx changes it to CAD.
    void           setModeCAD();
    // end RK changes
